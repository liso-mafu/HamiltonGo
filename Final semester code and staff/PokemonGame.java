...
public class PokemonGame {
    ...
    static String[] characterNames = {"Ash", "Cynthia", "Kendrick", "Tyla", "Hawk", "Wanda", "Drake", "Jessie"};
    static String[] characterImages = {"Ash.JPEG", "Cynthia.JPEG", "Kendrick.JPEG", "Tyla.JPEG",
                                       "Hawk.JPEG", "Wanda.JPEG", "Drake.JPEG", "Jessie.JPEG"};
    ...
    static String playerOnePokemon1, playerOnePokemon2, playerTwoPokemon1, playerTwoPokemon2;
  ...
  public static void main(String[] args) {
    ...
    try {
        ...
        JLabel welcomeLabel = new JLabel("Welcome to the Pokémon Game!");
        welcomeLabel.setFont(new Font("Serif", Font.BOLD, 40));
        welcomeLabel.setForeground(Color.BLACK);
        welcomeLabel.setBounds(20, 20, screenSize.width, 50);
        ...
        selectPlayersLabel.setFont(new Font("Serif", Font.BOLD, 30));
        selectPlayersLabel.setForeground(Color.BLACK);
        selectPlayersLabel.setBounds(20, 80, screenSize.width, 50);
        ...
        ActionListener buttonListener = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                numberOfPlayers = Integer.parseInt(clickedButton.getText()); // Store the selected number of players globally
        ...
        for (int i = 0; i < buttonNumbers.length; i++) {
            JButton playerButton = new JButton(String.valueOf(buttonNumbers[i]));
            playerButton.setBackground(Color.BLACK);
            playerButton.setForeground(Color.ORANGE);
            playerButton.setFont(new Font("Serif", Font.PLAIN, 18));
            playerButton.setBounds(xStart, yStart, (int) buttonSize, (int) buttonSize); // Square buttons
        ...
        nextButton.setBounds((int) xStart, yStart, (int) (screenSize.height * 0.30), (int) buttonSize);
...
private static void getPlayerNames(int numberOfPlayers) {
    ...
    private static void showGui2() {
        ...
        JLabel headingLabel = new JLabel(getPlayerNameByIndex(currentPlayerIndex) + ", select your character");
    ...
    private static void showGui3() {
        ...
        // Panel at the top with player name
        JLabel headingLabel = new JLabel(getPlayerNameByIndex(currentPlayerIndex) + ", select your two Pokémon");
        headingLabel.setFont(new Font("Serif", Font.BOLD, 30));
        headingLabel.setForeground(Color.ORANGE);
        headingLabel.setBackground(Color.BLACK);
        headingLabel.setOpaque(true); // Ensure the background color is applied
            ...
            selectButton.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (selectedPokemon.size() == 2) {
                        ...
                        switch (currentPlayerIndex) {
                            case 0:
                                playerOnePokemon1 = selectedPokemon.get(0);
                                playerOnePokemon2 = selectedPokemon.get(1);
                                break;
                            case 1:
                                playerTwoPokemon1 = selectedPokemon.get(0);
                                playerTwoPokemon2 = selectedPokemon.get(1);
                                break;
                            case 2:
...
private static void showGui4() {
    ...
    bottomLeftPanel = new JPanel() { // Initialize bottomLeftPanel
        ...
        protected void paintComponent(Graphics g) {
            super.paintComponent(g);
            try {
                Image pokemonImage = ImageIO.read(new File(playerOnePokemon2 + ".JPEG")); // Replace with your image file
    ...
    bottomRightPanel = new JPanel() { // Initialize bottomRightPanel
        ...
        protected void paintComponent(Graphics g) {
            super.paintComponent(g);
            try {
                Image pokemonImage = ImageIO.read(new File(playerTwoPokemon2 + ".JPEG")); // Replace with your image file
                g.drawImage(pokemonImage, 0, 0, getWidth(), getHeight(), this);
            } catch (IOException e) {
                e.printStackTrace();
            }
    ...
    leftSquarePanel = new JPanel() { // Initialize leftSquarePanel
        ...
        protected void paintComponent(Graphics g) {
            super.paintComponent(g);
            try {
                Image leftSquareImage = ImageIO.read(new File(playerOnePokemon1 + ".JPEG")); // Replace with your image file
    ...
    rightSquarePanel = new JPanel() { // Initialize rightSquarePanel
        ...
        protected void paintComponent(Graphics g) {
            super.paintComponent(g);
            try {
                Image rightSquareImage = ImageIO.read(new File(playerTwoPokemon1 + ".JPEG")); // Replace with your image file
    ...
    healthLabelLeft.setForeground(Color.ORANGE);
    ...
    energyLabelLeft.setForeground(Color.ORANGE);
    ...
    healthValueLeft = new JLabel("100", SwingConstants.CENTER);
    ...
    healthValueLeft.setBackground(Color.BLACK);
    healthValueLeft.setForeground(Color.ORANGE);
    ...
    JLabel energyValueLeft = new JLabel("100", SwingConstants.CENTER);
    ...
    energyValueLeft.setBackground(Color.BLACK);
    energyValueLeft.setForeground(Color.ORANGE);
    ...
    healthLabelRight.setForeground(Color.ORANGE);
    ...
    energyLabelRight.setForeground(Color.ORANGE);
    ...
    healthValueRight = new JLabel("100", SwingConstants.CENTER);
    ...
    healthValueRight.setBackground(Color.BLACK);
    healthValueRight.setForeground(Color.ORANGE);
    ...
    JLabel energyValueRight = new JLabel("100", SwingConstants.CENTER);
    ...
    energyValueRight.setBackground(Color.BLACK);
    energyValueRight.setForeground(Color.ORANGE);
        ...
        ActionListener attackAction = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (actionCommand.equals("Punch")) {
                    damage = randomDamage.nextInt(20);
                    attackImage = "punchImage.JPEG"; //  image file
                } else if (actionCommand.equals("Kick")) {
                    damage = randomDamage.nextInt(25);
                    attackImage = "kickImage.JPEG"; //  image file
                } else if (actionCommand.equals("Special Ability")) {
                    damage = randomDamage.nextInt(30);
                    attackImage = "specialAbilityImage.JPEG"; //  image file
                }
                ...
                Image attackImg = attackIcon.getImage().getScaledInstance((int) (screenSize.height * 0.11), (int) (screenSize.height * 0.11), Image.SCALE_SMOOTH);
                ...
                Timer timer = new Timer(10, new ActionListener() {
                    ...
                    int stepSize = 5; // Adjust the step size for consistent speed
