...
public class PokemonGame {
    ...
    static Character pikachu= new Character("Pikachu", 1.7,100,50,8,"Somthing about pikachu");
    static Character Lucario= new Character("Lucario", 1.6,200,25,9,"Somthing about pikachu");
    static Character garchomp= new Character("Garchomp", 1.2,300,30,10,"Somthing about pikachu");
    static Character greninja= new Character("Greninja", 1.7,150,30,10,"Somthing about pikachu");
    static Character zoroark= new Character("Zoroark", 1.4,250,40,5,"Somthing about pikachu");
    static Character Absol= new Character("Absol", 1.2,400,60,6,"Somthing about pikachu");
    static Character mewtwo= new Character("Mewtwo", 1.5,300,20,7,"Somthing about pikachu");
    static Character charizard= new Character("Charizard", 1.6,350,10,11,"Somthing about pikachu");
    static String[] characterNames = {"Ash", "Cynthia", "Brown", "Connan", "Yusuf", "Wells", "Z", "Jessie"};
    static String[] characterImages = {"Ash.JPEG", "Cynthia.JPEG", "Brown.JPEG", "Connan.JPEG",
                                       "Yusuf.JPEG", "Wells.JPG", "Z.JPEG", "Jessie.JPEG"};
  ...
  public static void showGui1(){
    ...
    try {
        ...
        for (int i = 0; i < buttonNumbers.length; i++) {
            JButton playerButton = new JButton("ENTER PLAYER NAMES: ");  //String.valueOf(buttonNumbers[i])
            ...
            playerButton.setBounds(xStart, yStart, (int) 500, (int) buttonSize); // Square buttons
        ...
        ActionListener attackAction = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (actionCommand.equals("Punch")) {
                    damage = randomDamage.nextInt(10,20);
                    costenergy=0;
                    ...
                    damage = randomDamage.nextInt(15,30);
                    costenergy=40;
                    punchButtonLeft.setEnabled(false);
                    kickButtonLeft.setEnabled(false);
                    specialAbilityButtonLeft.setEnabled(false);
                    ...
                    damage = randomDamage.nextInt(20,50);
                    costenergy=70;
                    punchButtonLeft.setEnabled(false);
                    kickButtonLeft.setEnabled(false);
                    specialAbilityButtonLeft.setEnabled(false);
                    ...
                    attackImage = "specialAbilityImage_V1.PNG"; //  image file
                }
